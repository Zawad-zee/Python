    ...
    def create_powerpoint(self, pptx_filename=None):
        ...
        for i, image_path in enumerate(self.snapshot_files, 1):
            ...
            try:
                ...
                # Extract timestamp from filename for slide title
                filename = os.path.basename(image_path)
                if '_t' in filename and 's.jpg' in filename:
                    timestamp_part = filename.split('_t')[1].replace('s.jpg', '')
                    try:
                ...
                # Add timestamp as text box at the bottom
                ...
                text_frame.text = f"Time: {time_str}"

                print(f"✓ Added slide {i}: {time_str}")
